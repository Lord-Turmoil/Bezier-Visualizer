...
{
public:
	Renderer() : m_width(0), m_height(0), m_symbol(nullptr), m_pTargetImage(nullptr) {}
	~Renderer() {}
	...
	void SetTargetImage(IMAGE* pTargetImage) { m_pTargetImage = pTargetImage; }
...
public:
	...
	*/
	void SetTargetImage(IMAGE* pDestImage = NULL);
