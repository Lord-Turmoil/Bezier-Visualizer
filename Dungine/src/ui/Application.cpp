...
/******************************************************************************
 * Application::Load -- Load config file for interfaces.                      *
 *                                                                            *
 *    Config file tells Application which xml files are to load.              *
 *                                                                            *
 * INPUT:   filename -- config xml file name.                                 *
 *                                                                            *
...
bool Application::Load(const char* filename)
{
	/*
	**	<UI>
	**		<Filename>Filename1.xml</Filename>
	**		<Filename>Filename2.xml</Filename>
	**		<Filename>Filename3.xml</Filename>
	**		...
	**	</UI>
	*/
	XMLFile doc;
	...
	{
		LOG_ERROR("Failed to load UI config file - \"%s\"", filename);
		return false;
	}
	...
	{
		file = node->GetText();
		if (file)	// skip empty entry
		{
			if (!_Load(file))
			{
				LOG_ERROR(FAILED_TO_LOAD_UI);
				UnLoad();
				return false;
			}
		}
...
/******************************************************************************
 * Application::_Load -- Load all interfaces.                                 *
 *                                                                            *
 ...
 *   2022/06/02 Tony : Created.                                               *
 *============================================================================*/
bool Application::_Load(const char* filename)
{
	/*
	**	<UI>
